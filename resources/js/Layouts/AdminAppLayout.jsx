...
export default function AdminAppLayout({ children }) {
    ...
    const { auth, supabase, flash } = usePage().props;
                        ...
                        <div className="px-4 sm:px-6 lg:px-8">
                            <div className="flex justify-between h-16">
                                ...
                                <div className="hidden sm:flex sm:items-center sm:ms-6 justify-end">
                                    ...
                                    <Link
                                        href={route('admin.settings')}
                                        className="p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 mr-2"
                                    >
